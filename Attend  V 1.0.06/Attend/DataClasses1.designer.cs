...
namespace Attend
{
    ...
    partial void InsertFIC(FIC instance);
    partial void UpdateFIC(FIC instance);
    partial void DeleteFIC(FIC instance);
    #endregion
		...
		public System.Data.Linq.Table<FIC> FICs
		{
			get
			{
				return this.GetTable<FIC>();
			}
		}
	}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.FIC")]
	public partial class FIC : INotifyPropertyChanging, INotifyPropertyChanged
	{
